...
<%@ page import="java.util.Date" import="java.time.* "
	...
	import="java.io.*" import="java.util.*" import="java.time.ZoneId"
				...
				<ul class="list-group list-group-light list-group-small">
					...
					<c:choose>
						<c:when test="${item.getReturnDate() ne null}">
							<li class="list-group-item px-4" style="color: green"><b>Status:</b>
								Book Is submitted</li>
						</c:when>

						<c:otherwise>
							<li class="list-group-item px-4" style="color: red"><b>Status:</b>
								Book Is not submitted</li>
						</c:otherwise>
					</c:choose>
